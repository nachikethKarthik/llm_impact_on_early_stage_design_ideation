...
with open('D:/research/llm_impact_on_early_stage_design_ideation/on_campus_students/experiment_2/tokenized_df_with_empty_strings.pkl', 'rb') as f:
...
def plot_clusters(embeddings_2d):
    ...
    colors = ['red', 'blue','green','yellow','brown','gray','orange','purple','black','cyan']
